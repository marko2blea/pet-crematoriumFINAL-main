<template>
  <div>
    ...
    <section class="py-16 bg-gray-50">
      <div class="container mx-auto px-4">
        <h2 class="text-3xl font-extrabold text-purple-dark mb-12 text-center animate-slide-in-top">
          Conócenos y Nuestras Instalaciones
        </h2>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">

          <div class="relative rounded-xl overflow-hidden shadow-xl transform transition duration-300 hover:scale-105">
